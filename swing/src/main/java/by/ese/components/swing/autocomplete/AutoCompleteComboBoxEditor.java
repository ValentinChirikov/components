...
public class AutoCompleteComboBoxEditor implements ComboBoxEditor {
     ...
     *
     * @param editor         the original <tt>ComboBoxEditor</tt> to be wrapped
     * @param stringConverter the converter to use to convert items into their
     *                        string representation.
     */
    public AutoCompleteComboBoxEditor(ComboBoxEditor editor, ObjectToStringConverter stringConverter) {
        this.wrapped = editor;
    ...
    public Object getItem() {
        ...
        //return null; //makes impossible to select item on enter key
        return "";
    }
