 ...
 * </p>
 * <p>
 * <img alt="Example image" src="doc-files/example.gif">
 * </p>
 * <p>
 * The easiest way to get automatic completion for a component is to use the
 * {@link by.ese.components.swing.autocomplete.AutoCompleteDecorator AutoCompleteDecorator}.
 * </p>
 * <p>Enabling automatic completion for e.g. a JComboBox is only one line of
 * code:</p>
 * <p><code>
 * <span class="keyword">import</span> by.ese.components.swing.autocompleteDecorator;<br>
 * [...]<br>
 * JComboBox comboBox = [...];<br>
 * AutoCompleteDecorator.<b>decorate</b>(comboBox);
 * </code></p>
 * <p>When the combo box is not editable when calling
 * {@link by.ese.components.swing.autocomplete.AutoCompleteDecorator#decorate(javax.swing.JComboBox)}
 ...
 * {@link by.ese.components.swing.autocomplete.ComboBoxCellEditor ComboBoxCellEditor}
 ...
 * supported by the {@link by.ese.components.swing.autocomplete.AutoCompleteDecorator AutoCompleteDecorator}, you
 * need to implement {@link by.ese.components.swing.autocomplete.adaptor.AbstractAutoCompleteAdaptor AbstractAutoCompleteAdaptor}. For
 * an example see {@link by.ese.components.swing.autocomplete.adaptor.ComboBoxAdaptor ComboBoxAdaptor}
 * and {@link by.ese.components.swing.autocomplete.adaptor.ListAdaptor ListAdaptor}.
 * </p>
 * <p>
 ...
 * {@link by.ese.components.swing.autocomplete.adaptor.AbstractAutoCompleteAdaptor AbstractAutoCompleteAdaptor},
