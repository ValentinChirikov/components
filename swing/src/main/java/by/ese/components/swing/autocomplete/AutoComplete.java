...
import by.ese.components.swing.autocomplete.adaptor.ComboBoxAdaptor;
...
import static by.ese.components.swing.autocomplete.AutoCompleteDecorator.*;
...
final class AutoComplete {
    ...
    static class FocusAdapter extends java.awt.event.FocusAdapter {
        private AutoCompleteAdaptor adaptor;

        public FocusAdapter(AutoCompleteAdaptor adaptor) {
    ...
    static class PropertyChangeListener implements java.beans.PropertyChangeListener {
        ...
        private void handleEditor(PropertyChangeEvent evt) {
            ...
            AutoCompleteAdaptor adaptor = new ComboBoxAdaptor(comboBox);
