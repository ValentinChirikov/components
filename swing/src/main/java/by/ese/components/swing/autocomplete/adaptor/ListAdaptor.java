...
import by.ese.components.swing.autocomplete.converter.DefaultObjectToStringConverter;
...
public class ListAdaptor extends AbstractAutoCompleteAdaptor implements ListSelectionListener {
    ...
    public ListAdaptor(JList list, JTextComponent textComponent) {
        this(list, textComponent, DefaultObjectToStringConverter.DEFAULT_IMPLEMENTATION);
    }
