/*
 * (C) Copyright 3 дек. 2018 г. Valentin Chirikov (http://ese.by/) 
 ...
 * @author Valentin
 */
public class CrudControlsBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( by.ese.components.swing.panel.CrudControls.class , null ); // NOI18N
        beanDescriptor.setDisplayName ( "CRUD controls" );//GEN-HEADEREND:BeanDescriptor
    ...
    private static final int PROPERTY_btnCommitEnabled = 11;
    private static final int PROPERTY_btnCommitLabel = 12;
    private static final int PROPERTY_btnCommitTooltip = 13;
    private static final int PROPERTY_btnCommitVisible = 14;
    private static final int PROPERTY_btnCreateEnabled = 15;
    private static final int PROPERTY_btnCreateLabel = 16;
    private static final int PROPERTY_btnCreateTooltip = 17;
    private static final int PROPERTY_btnCreateVisible = 18;
    private static final int PROPERTY_btnDeleteEnabled = 19;
    private static final int PROPERTY_btnDeleteLabel = 20;
    private static final int PROPERTY_btnDeleteTooltip = 21;
    private static final int PROPERTY_btnDeleteVisible = 22;
    private static final int PROPERTY_btnEditEnabled = 23;
    private static final int PROPERTY_btnEditLabel = 24;
    private static final int PROPERTY_btnEditTooltip = 25;
    private static final int PROPERTY_btnEditVisible = 26;
    private static final int PROPERTY_btnRedoEnabled = 27;
    private static final int PROPERTY_btnRedoLabel = 28;
    private static final int PROPERTY_btnRedoTooltip = 29;
    private static final int PROPERTY_btnRedoVisible = 30;
    private static final int PROPERTY_btnRefreshEnabled = 31;
    private static final int PROPERTY_btnRefreshLabel = 32;
    private static final int PROPERTY_btnRefreshTooltip = 33;
    private static final int PROPERTY_btnRefreshVisible = 34;
    private static final int PROPERTY_btnUndoEnabled = 35;
    private static final int PROPERTY_btnUndoLabel = 36;
    private static final int PROPERTY_btnUndoTooltip = 37;
    private static final int PROPERTY_btnUndoVisible = 38;
    private static final int PROPERTY_colorModel = 39;
    private static final int PROPERTY_component = 40;
    private static final int PROPERTY_componentCount = 41;
    private static final int PROPERTY_componentListeners = 42;
    private static final int PROPERTY_componentOrientation = 43;
    private static final int PROPERTY_componentPopupMenu = 44;
    private static final int PROPERTY_components = 45;
    private static final int PROPERTY_containerListeners = 46;
    private static final int PROPERTY_cursor = 47;
    private static final int PROPERTY_cursorSet = 48;
    private static final int PROPERTY_debugGraphicsOptions = 49;
    private static final int PROPERTY_displayable = 50;
    private static final int PROPERTY_doubleBuffered = 51;
    private static final int PROPERTY_dropTarget = 52;
    private static final int PROPERTY_enabled = 53;
    private static final int PROPERTY_focusable = 54;
    private static final int PROPERTY_focusCycleRoot = 55;
    private static final int PROPERTY_focusCycleRootAncestor = 56;
    private static final int PROPERTY_focusListeners = 57;
    private static final int PROPERTY_focusOwner = 58;
    private static final int PROPERTY_focusTraversable = 59;
    private static final int PROPERTY_focusTraversalKeys = 60;
    private static final int PROPERTY_focusTraversalKeysEnabled = 61;
    private static final int PROPERTY_focusTraversalPolicy = 62;
    private static final int PROPERTY_focusTraversalPolicyProvider = 63;
    private static final int PROPERTY_focusTraversalPolicySet = 64;
    private static final int PROPERTY_font = 65;
    private static final int PROPERTY_fontSet = 66;
    private static final int PROPERTY_foreground = 67;
    private static final int PROPERTY_foregroundSet = 68;
    private static final int PROPERTY_graphics = 69;
    private static final int PROPERTY_graphicsConfiguration = 70;
    private static final int PROPERTY_height = 71;
    private static final int PROPERTY_hierarchyBoundsListeners = 72;
    private static final int PROPERTY_hierarchyListeners = 73;
    ...
    private static final int PROPERTY_keyListeners = 82;
    ...
    private static final int PROPERTY_managingFocus = 88;
    private static final int PROPERTY_maximumSize = 89;
    private static final int PROPERTY_maximumSizeSet = 90;
    private static final int PROPERTY_minimumSize = 91;
    private static final int PROPERTY_minimumSizeSet = 92;
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_accessibleContext] = new PropertyDescriptor ( "accessibleContext", by.ese.components.swing.panel.CrudControls.class, "getAccessibleContext", null ); // NOI18N
            properties[PROPERTY_actionMap] = new PropertyDescriptor ( "actionMap", by.ese.components.swing.panel.CrudControls.class, "getActionMap", "setActionMap" ); // NOI18N
            properties[PROPERTY_alignmentX] = new PropertyDescriptor ( "alignmentX", by.ese.components.swing.panel.CrudControls.class, "getAlignmentX", "setAlignmentX" ); // NOI18N
            properties[PROPERTY_alignmentY] = new PropertyDescriptor ( "alignmentY", by.ese.components.swing.panel.CrudControls.class, "getAlignmentY", "setAlignmentY" ); // NOI18N
            properties[PROPERTY_ancestorListeners] = new PropertyDescriptor ( "ancestorListeners", by.ese.components.swing.panel.CrudControls.class, "getAncestorListeners", null ); // NOI18N
            properties[PROPERTY_autoscrolls] = new PropertyDescriptor ( "autoscrolls", by.ese.components.swing.panel.CrudControls.class, "getAutoscrolls", "setAutoscrolls" ); // NOI18N
            properties[PROPERTY_background] = new PropertyDescriptor ( "background", by.ese.components.swing.panel.CrudControls.class, "getBackground", "setBackground" ); // NOI18N
            properties[PROPERTY_backgroundSet] = new PropertyDescriptor ( "backgroundSet", by.ese.components.swing.panel.CrudControls.class, "isBackgroundSet", null ); // NOI18N
            properties[PROPERTY_baselineResizeBehavior] = new PropertyDescriptor ( "baselineResizeBehavior", by.ese.components.swing.panel.CrudControls.class, "getBaselineResizeBehavior", null ); // NOI18N
            properties[PROPERTY_border] = new PropertyDescriptor ( "border", by.ese.components.swing.panel.CrudControls.class, "getBorder", "setBorder" ); // NOI18N
            properties[PROPERTY_bounds] = new PropertyDescriptor ( "bounds", by.ese.components.swing.panel.CrudControls.class, "getBounds", "setBounds" ); // NOI18N
            properties[PROPERTY_btnCommitEnabled] = new PropertyDescriptor ( "btnCommitEnabled", by.ese.components.swing.panel.CrudControls.class, "isBtnCommitEnabled", "setBtnCommitEnabled" ); // NOI18N
            properties[PROPERTY_btnCommitLabel] = new PropertyDescriptor ( "btnCommitLabel", by.ese.components.swing.panel.CrudControls.class, "getBtnCommitLabel", "setBtnCommitLabel" ); // NOI18N
            properties[PROPERTY_btnCommitTooltip] = new PropertyDescriptor ( "btnCommitTooltip", by.ese.components.swing.panel.CrudControls.class, "getBtnCommitTooltip", "setBtnCommitTooltip" ); // NOI18N
            properties[PROPERTY_btnCommitVisible] = new PropertyDescriptor ( "btnCommitVisible", by.ese.components.swing.panel.CrudControls.class, "getBtnCommitVisible", "setBtnCommitVisible" ); // NOI18N
            properties[PROPERTY_btnCreateEnabled] = new PropertyDescriptor ( "btnCreateEnabled", by.ese.components.swing.panel.CrudControls.class, "isBtnCreateEnabled", "setBtnCreateEnabled" ); // NOI18N
            properties[PROPERTY_btnCreateLabel] = new PropertyDescriptor ( "btnCreateLabel", by.ese.components.swing.panel.CrudControls.class, "getBtnCreateLabel", "setBtnCreateLabel" ); // NOI18N
            properties[PROPERTY_btnCreateTooltip] = new PropertyDescriptor ( "btnCreateTooltip", by.ese.components.swing.panel.CrudControls.class, "getBtnCreateTooltip", "setBtnCreateTooltip" ); // NOI18N
            properties[PROPERTY_btnCreateVisible] = new PropertyDescriptor ( "btnCreateVisible", by.ese.components.swing.panel.CrudControls.class, "isBtnCreateVisible", "setBtnCreateVisible" ); // NOI18N
            properties[PROPERTY_btnDeleteEnabled] = new PropertyDescriptor ( "btnDeleteEnabled", by.ese.components.swing.panel.CrudControls.class, "isBtnDeleteEnabled", "setBtnDeleteEnabled" ); // NOI18N
            properties[PROPERTY_btnDeleteLabel] = new PropertyDescriptor ( "btnDeleteLabel", by.ese.components.swing.panel.CrudControls.class, "getBtnDeleteLabel", "setBtnDeleteLabel" ); // NOI18N
            properties[PROPERTY_btnDeleteTooltip] = new PropertyDescriptor ( "btnDeleteTooltip", by.ese.components.swing.panel.CrudControls.class, "getBtnDeleteTooltip", "setBtnDeleteTooltip" ); // NOI18N
            properties[PROPERTY_btnDeleteVisible] = new PropertyDescriptor ( "btnDeleteVisible", by.ese.components.swing.panel.CrudControls.class, "isBtnDeleteVisible", "setBtnDeleteVisible" ); // NOI18N
            properties[PROPERTY_btnEditEnabled] = new PropertyDescriptor ( "btnEditEnabled", by.ese.components.swing.panel.CrudControls.class, "isBtnEditEnabled", "setBtnEditEnabled" ); // NOI18N
            properties[PROPERTY_btnEditLabel] = new PropertyDescriptor ( "btnEditLabel", by.ese.components.swing.panel.CrudControls.class, "getBtnEditLabel", "setBtnEditLabel" ); // NOI18N
            properties[PROPERTY_btnEditTooltip] = new PropertyDescriptor ( "btnEditTooltip", by.ese.components.swing.panel.CrudControls.class, "getBtnEditTooltip", "setBtnEditTooltip" ); // NOI18N
            properties[PROPERTY_btnEditVisible] = new PropertyDescriptor ( "btnEditVisible", by.ese.components.swing.panel.CrudControls.class, "isBtnEditVisible", "setBtnEditVisible" ); // NOI18N
            properties[PROPERTY_btnRedoEnabled] = new PropertyDescriptor ( "btnRedoEnabled", by.ese.components.swing.panel.CrudControls.class, "isBtnRedoEnabled", "setBtnRedoEnabled" ); // NOI18N
            properties[PROPERTY_btnRedoLabel] = new PropertyDescriptor ( "btnRedoLabel", by.ese.components.swing.panel.CrudControls.class, "getBtnRedoLabel", "setBtnRedoLabel" ); // NOI18N
            properties[PROPERTY_btnRedoTooltip] = new PropertyDescriptor ( "btnRedoTooltip", by.ese.components.swing.panel.CrudControls.class, "getBtnRedoTooltip", "setBtnRedoTooltip" ); // NOI18N
            properties[PROPERTY_btnRedoVisible] = new PropertyDescriptor ( "btnRedoVisible", by.ese.components.swing.panel.CrudControls.class, "isBtnRedoVisible", "setBtnRedoVisible" ); // NOI18N
            properties[PROPERTY_btnRefreshEnabled] = new PropertyDescriptor ( "btnRefreshEnabled", by.ese.components.swing.panel.CrudControls.class, "isBtnRefreshEnabled", "setBtnRefreshEnabled" ); // NOI18N
            properties[PROPERTY_btnRefreshLabel] = new PropertyDescriptor ( "btnRefreshLabel", by.ese.components.swing.panel.CrudControls.class, "getBtnRefreshLabel", "setBtnRefreshLabel" ); // NOI18N
            properties[PROPERTY_btnRefreshTooltip] = new PropertyDescriptor ( "btnRefreshTooltip", by.ese.components.swing.panel.CrudControls.class, "getBtnRefreshTooltip", "setBtnRefreshTooltip" ); // NOI18N
            properties[PROPERTY_btnRefreshVisible] = new PropertyDescriptor ( "btnRefreshVisible", by.ese.components.swing.panel.CrudControls.class, "isBtnRefreshVisible", "setBtnRefreshVisible" ); // NOI18N
            properties[PROPERTY_btnUndoEnabled] = new PropertyDescriptor ( "btnUndoEnabled", by.ese.components.swing.panel.CrudControls.class, "isBtnUndoEnabled", "setBtnUndoEnabled" ); // NOI18N
            properties[PROPERTY_btnUndoLabel] = new PropertyDescriptor ( "btnUndoLabel", by.ese.components.swing.panel.CrudControls.class, "getBtnUndoLabel", "setBtnUndoLabel" ); // NOI18N
            properties[PROPERTY_btnUndoTooltip] = new PropertyDescriptor ( "btnUndoTooltip", by.ese.components.swing.panel.CrudControls.class, "getBtnUndoTooltip", "setBtnUndoTooltip" ); // NOI18N
            properties[PROPERTY_btnUndoVisible] = new PropertyDescriptor ( "btnUndoVisible", by.ese.components.swing.panel.CrudControls.class, "isBtnUndoVisible", "setBtnUndoVisible" ); // NOI18N
            properties[PROPERTY_colorModel] = new PropertyDescriptor ( "colorModel", by.ese.components.swing.panel.CrudControls.class, "getColorModel", null ); // NOI18N
            properties[PROPERTY_component] = new IndexedPropertyDescriptor ( "component", by.ese.components.swing.panel.CrudControls.class, null, null, "getComponent", null ); // NOI18N
            properties[PROPERTY_componentCount] = new PropertyDescriptor ( "componentCount", by.ese.components.swing.panel.CrudControls.class, "getComponentCount", null ); // NOI18N
            properties[PROPERTY_componentListeners] = new PropertyDescriptor ( "componentListeners", by.ese.components.swing.panel.CrudControls.class, "getComponentListeners", null ); // NOI18N
            properties[PROPERTY_componentOrientation] = new PropertyDescriptor ( "componentOrientation", by.ese.components.swing.panel.CrudControls.class, "getComponentOrientation", "setComponentOrientation" ); // NOI18N
            properties[PROPERTY_componentPopupMenu] = new PropertyDescriptor ( "componentPopupMenu", by.ese.components.swing.panel.CrudControls.class, "getComponentPopupMenu", "setComponentPopupMenu" ); // NOI18N
            properties[PROPERTY_components] = new PropertyDescriptor ( "components", by.ese.components.swing.panel.CrudControls.class, "getComponents", null ); // NOI18N
            properties[PROPERTY_containerListeners] = new PropertyDescriptor ( "containerListeners", by.ese.components.swing.panel.CrudControls.class, "getContainerListeners", null ); // NOI18N
            properties[PROPERTY_cursor] = new PropertyDescriptor ( "cursor", by.ese.components.swing.panel.CrudControls.class, "getCursor", "setCursor" ); // NOI18N
            properties[PROPERTY_cursorSet] = new PropertyDescriptor ( "cursorSet", by.ese.components.swing.panel.CrudControls.class, "isCursorSet", null ); // NOI18N
            properties[PROPERTY_debugGraphicsOptions] = new PropertyDescriptor ( "debugGraphicsOptions", by.ese.components.swing.panel.CrudControls.class, "getDebugGraphicsOptions", "setDebugGraphicsOptions" ); // NOI18N
            properties[PROPERTY_displayable] = new PropertyDescriptor ( "displayable", by.ese.components.swing.panel.CrudControls.class, "isDisplayable", null ); // NOI18N
            properties[PROPERTY_doubleBuffered] = new PropertyDescriptor ( "doubleBuffered", by.ese.components.swing.panel.CrudControls.class, "isDoubleBuffered", "setDoubleBuffered" ); // NOI18N
            properties[PROPERTY_dropTarget] = new PropertyDescriptor ( "dropTarget", by.ese.components.swing.panel.CrudControls.class, "getDropTarget", "setDropTarget" ); // NOI18N
            properties[PROPERTY_enabled] = new PropertyDescriptor ( "enabled", by.ese.components.swing.panel.CrudControls.class, "isEnabled", "setEnabled" ); // NOI18N
            properties[PROPERTY_focusable] = new PropertyDescriptor ( "focusable", by.ese.components.swing.panel.CrudControls.class, "isFocusable", "setFocusable" ); // NOI18N
            properties[PROPERTY_focusCycleRoot] = new PropertyDescriptor ( "focusCycleRoot", by.ese.components.swing.panel.CrudControls.class, "isFocusCycleRoot", "setFocusCycleRoot" ); // NOI18N
            properties[PROPERTY_focusCycleRootAncestor] = new PropertyDescriptor ( "focusCycleRootAncestor", by.ese.components.swing.panel.CrudControls.class, "getFocusCycleRootAncestor", null ); // NOI18N
            properties[PROPERTY_focusListeners] = new PropertyDescriptor ( "focusListeners", by.ese.components.swing.panel.CrudControls.class, "getFocusListeners", null ); // NOI18N
            properties[PROPERTY_focusOwner] = new PropertyDescriptor ( "focusOwner", by.ese.components.swing.panel.CrudControls.class, "isFocusOwner", null ); // NOI18N
            properties[PROPERTY_focusTraversable] = new PropertyDescriptor ( "focusTraversable", by.ese.components.swing.panel.CrudControls.class, "isFocusTraversable", null ); // NOI18N
            properties[PROPERTY_focusTraversalKeys] = new IndexedPropertyDescriptor ( "focusTraversalKeys", by.ese.components.swing.panel.CrudControls.class, null, null, null, "setFocusTraversalKeys" ); // NOI18N
            properties[PROPERTY_focusTraversalKeysEnabled] = new PropertyDescriptor ( "focusTraversalKeysEnabled", by.ese.components.swing.panel.CrudControls.class, "getFocusTraversalKeysEnabled", "setFocusTraversalKeysEnabled" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicy] = new PropertyDescriptor ( "focusTraversalPolicy", by.ese.components.swing.panel.CrudControls.class, "getFocusTraversalPolicy", "setFocusTraversalPolicy" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicyProvider] = new PropertyDescriptor ( "focusTraversalPolicyProvider", by.ese.components.swing.panel.CrudControls.class, "isFocusTraversalPolicyProvider", "setFocusTraversalPolicyProvider" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicySet] = new PropertyDescriptor ( "focusTraversalPolicySet", by.ese.components.swing.panel.CrudControls.class, "isFocusTraversalPolicySet", null ); // NOI18N
            properties[PROPERTY_font] = new PropertyDescriptor ( "font", by.ese.components.swing.panel.CrudControls.class, "getFont", "setFont" ); // NOI18N
            properties[PROPERTY_fontSet] = new PropertyDescriptor ( "fontSet", by.ese.components.swing.panel.CrudControls.class, "isFontSet", null ); // NOI18N
            properties[PROPERTY_foreground] = new PropertyDescriptor ( "foreground", by.ese.components.swing.panel.CrudControls.class, "getForeground", "setForeground" ); // NOI18N
            properties[PROPERTY_foregroundSet] = new PropertyDescriptor ( "foregroundSet", by.ese.components.swing.panel.CrudControls.class, "isForegroundSet", null ); // NOI18N
            properties[PROPERTY_graphics] = new PropertyDescriptor ( "graphics", by.ese.components.swing.panel.CrudControls.class, "getGraphics", null ); // NOI18N
            properties[PROPERTY_graphicsConfiguration] = new PropertyDescriptor ( "graphicsConfiguration", by.ese.components.swing.panel.CrudControls.class, "getGraphicsConfiguration", null ); // NOI18N
            properties[PROPERTY_height] = new PropertyDescriptor ( "height", by.ese.components.swing.panel.CrudControls.class, "getHeight", null ); // NOI18N
            properties[PROPERTY_hierarchyBoundsListeners] = new PropertyDescriptor ( "hierarchyBoundsListeners", by.ese.components.swing.panel.CrudControls.class, "getHierarchyBoundsListeners", null ); // NOI18N
            properties[PROPERTY_hierarchyListeners] = new PropertyDescriptor ( "hierarchyListeners", by.ese.components.swing.panel.CrudControls.class, "getHierarchyListeners", null ); // NOI18N
            properties[PROPERTY_ignoreRepaint] = new PropertyDescriptor ( "ignoreRepaint", by.ese.components.swing.panel.CrudControls.class, "getIgnoreRepaint", "setIgnoreRepaint" ); // NOI18N
            properties[PROPERTY_inheritsPopupMenu] = new PropertyDescriptor ( "inheritsPopupMenu", by.ese.components.swing.panel.CrudControls.class, "getInheritsPopupMenu", "setInheritsPopupMenu" ); // NOI18N
            properties[PROPERTY_inputContext] = new PropertyDescriptor ( "inputContext", by.ese.components.swing.panel.CrudControls.class, "getInputContext", null ); // NOI18N
            properties[PROPERTY_inputMap] = new PropertyDescriptor ( "inputMap", by.ese.components.swing.panel.CrudControls.class, "getInputMap", null ); // NOI18N
            properties[PROPERTY_inputMethodListeners] = new PropertyDescriptor ( "inputMethodListeners", by.ese.components.swing.panel.CrudControls.class, "getInputMethodListeners", null ); // NOI18N
            properties[PROPERTY_inputMethodRequests] = new PropertyDescriptor ( "inputMethodRequests", by.ese.components.swing.panel.CrudControls.class, "getInputMethodRequests", null ); // NOI18N
            properties[PROPERTY_inputVerifier] = new PropertyDescriptor ( "inputVerifier", by.ese.components.swing.panel.CrudControls.class, "getInputVerifier", "setInputVerifier" ); // NOI18N
            properties[PROPERTY_insets] = new PropertyDescriptor ( "insets", by.ese.components.swing.panel.CrudControls.class, "getInsets", null ); // NOI18N
            properties[PROPERTY_keyListeners] = new PropertyDescriptor ( "keyListeners", by.ese.components.swing.panel.CrudControls.class, "getKeyListeners", null ); // NOI18N
            properties[PROPERTY_layout] = new PropertyDescriptor ( "layout", by.ese.components.swing.panel.CrudControls.class, "getLayout", "setLayout" ); // NOI18N
            properties[PROPERTY_lightweight] = new PropertyDescriptor ( "lightweight", by.ese.components.swing.panel.CrudControls.class, "isLightweight", null ); // NOI18N
            properties[PROPERTY_locale] = new PropertyDescriptor ( "locale", by.ese.components.swing.panel.CrudControls.class, "getLocale", "setLocale" ); // NOI18N
            properties[PROPERTY_location] = new PropertyDescriptor ( "location", by.ese.components.swing.panel.CrudControls.class, "getLocation", "setLocation" ); // NOI18N
            properties[PROPERTY_locationOnScreen] = new PropertyDescriptor ( "locationOnScreen", by.ese.components.swing.panel.CrudControls.class, "getLocationOnScreen", null ); // NOI18N
            properties[PROPERTY_managingFocus] = new PropertyDescriptor ( "managingFocus", by.ese.components.swing.panel.CrudControls.class, "isManagingFocus", null ); // NOI18N
            properties[PROPERTY_maximumSize] = new PropertyDescriptor ( "maximumSize", by.ese.components.swing.panel.CrudControls.class, "getMaximumSize", "setMaximumSize" ); // NOI18N
            properties[PROPERTY_maximumSizeSet] = new PropertyDescriptor ( "maximumSizeSet", by.ese.components.swing.panel.CrudControls.class, "isMaximumSizeSet", null ); // NOI18N
            properties[PROPERTY_minimumSize] = new PropertyDescriptor ( "minimumSize", by.ese.components.swing.panel.CrudControls.class, "getMinimumSize", "setMinimumSize" ); // NOI18N
            properties[PROPERTY_minimumSizeSet] = new PropertyDescriptor ( "minimumSizeSet", by.ese.components.swing.panel.CrudControls.class, "isMinimumSizeSet", null ); // NOI18N
            properties[PROPERTY_mouseListeners] = new PropertyDescriptor ( "mouseListeners", by.ese.components.swing.panel.CrudControls.class, "getMouseListeners", null ); // NOI18N
            properties[PROPERTY_mouseMotionListeners] = new PropertyDescriptor ( "mouseMotionListeners", by.ese.components.swing.panel.CrudControls.class, "getMouseMotionListeners", null ); // NOI18N
            properties[PROPERTY_mousePosition] = new PropertyDescriptor ( "mousePosition", by.ese.components.swing.panel.CrudControls.class, "getMousePosition", null ); // NOI18N
            properties[PROPERTY_mouseWheelListeners] = new PropertyDescriptor ( "mouseWheelListeners", by.ese.components.swing.panel.CrudControls.class, "getMouseWheelListeners", null ); // NOI18N
            properties[PROPERTY_name] = new PropertyDescriptor ( "name", by.ese.components.swing.panel.CrudControls.class, "getName", "setName" ); // NOI18N
            properties[PROPERTY_nextFocusableComponent] = new PropertyDescriptor ( "nextFocusableComponent", by.ese.components.swing.panel.CrudControls.class, "getNextFocusableComponent", "setNextFocusableComponent" ); // NOI18N
            properties[PROPERTY_opaque] = new PropertyDescriptor ( "opaque", by.ese.components.swing.panel.CrudControls.class, "isOpaque", "setOpaque" ); // NOI18N
            properties[PROPERTY_optimizedDrawingEnabled] = new PropertyDescriptor ( "optimizedDrawingEnabled", by.ese.components.swing.panel.CrudControls.class, "isOptimizedDrawingEnabled", null ); // NOI18N
            properties[PROPERTY_paintingForPrint] = new PropertyDescriptor ( "paintingForPrint", by.ese.components.swing.panel.CrudControls.class, "isPaintingForPrint", null ); // NOI18N
            properties[PROPERTY_paintingTile] = new PropertyDescriptor ( "paintingTile", by.ese.components.swing.panel.CrudControls.class, "isPaintingTile", null ); // NOI18N
            properties[PROPERTY_parent] = new PropertyDescriptor ( "parent", by.ese.components.swing.panel.CrudControls.class, "getParent", null ); // NOI18N
            properties[PROPERTY_preferredSize] = new PropertyDescriptor ( "preferredSize", by.ese.components.swing.panel.CrudControls.class, "getPreferredSize", "setPreferredSize" ); // NOI18N
            properties[PROPERTY_preferredSizeSet] = new PropertyDescriptor ( "preferredSizeSet", by.ese.components.swing.panel.CrudControls.class, "isPreferredSizeSet", null ); // NOI18N
            properties[PROPERTY_propertyChangeListeners] = new PropertyDescriptor ( "propertyChangeListeners", by.ese.components.swing.panel.CrudControls.class, "getPropertyChangeListeners", null ); // NOI18N
            properties[PROPERTY_registeredKeyStrokes] = new PropertyDescriptor ( "registeredKeyStrokes", by.ese.components.swing.panel.CrudControls.class, "getRegisteredKeyStrokes", null ); // NOI18N
            properties[PROPERTY_requestFocusEnabled] = new PropertyDescriptor ( "requestFocusEnabled", by.ese.components.swing.panel.CrudControls.class, "isRequestFocusEnabled", "setRequestFocusEnabled" ); // NOI18N
            properties[PROPERTY_rootPane] = new PropertyDescriptor ( "rootPane", by.ese.components.swing.panel.CrudControls.class, "getRootPane", null ); // NOI18N
            properties[PROPERTY_showing] = new PropertyDescriptor ( "showing", by.ese.components.swing.panel.CrudControls.class, "isShowing", null ); // NOI18N
            properties[PROPERTY_size] = new PropertyDescriptor ( "size", by.ese.components.swing.panel.CrudControls.class, "getSize", "setSize" ); // NOI18N
            properties[PROPERTY_toolkit] = new PropertyDescriptor ( "toolkit", by.ese.components.swing.panel.CrudControls.class, "getToolkit", null ); // NOI18N
            properties[PROPERTY_toolTipText] = new PropertyDescriptor ( "toolTipText", by.ese.components.swing.panel.CrudControls.class, "getToolTipText", "setToolTipText" ); // NOI18N
            properties[PROPERTY_topLevelAncestor] = new PropertyDescriptor ( "topLevelAncestor", by.ese.components.swing.panel.CrudControls.class, "getTopLevelAncestor", null ); // NOI18N
            properties[PROPERTY_transferHandler] = new PropertyDescriptor ( "transferHandler", by.ese.components.swing.panel.CrudControls.class, "getTransferHandler", "setTransferHandler" ); // NOI18N
            properties[PROPERTY_treeLock] = new PropertyDescriptor ( "treeLock", by.ese.components.swing.panel.CrudControls.class, "getTreeLock", null ); // NOI18N
            properties[PROPERTY_UI] = new PropertyDescriptor ( "UI", by.ese.components.swing.panel.CrudControls.class, "getUI", "setUI" ); // NOI18N
            properties[PROPERTY_UIClassID] = new PropertyDescriptor ( "UIClassID", by.ese.components.swing.panel.CrudControls.class, "getUIClassID", null ); // NOI18N
            properties[PROPERTY_valid] = new PropertyDescriptor ( "valid", by.ese.components.swing.panel.CrudControls.class, "isValid", null ); // NOI18N
            properties[PROPERTY_validateRoot] = new PropertyDescriptor ( "validateRoot", by.ese.components.swing.panel.CrudControls.class, "isValidateRoot", null ); // NOI18N
            properties[PROPERTY_verifyInputWhenFocusTarget] = new PropertyDescriptor ( "verifyInputWhenFocusTarget", by.ese.components.swing.panel.CrudControls.class, "getVerifyInputWhenFocusTarget", "setVerifyInputWhenFocusTarget" ); // NOI18N
            properties[PROPERTY_vetoableChangeListeners] = new PropertyDescriptor ( "vetoableChangeListeners", by.ese.components.swing.panel.CrudControls.class, "getVetoableChangeListeners", null ); // NOI18N
            properties[PROPERTY_visible] = new PropertyDescriptor ( "visible", by.ese.components.swing.panel.CrudControls.class, "isVisible", "setVisible" ); // NOI18N
            properties[PROPERTY_visibleRect] = new PropertyDescriptor ( "visibleRect", by.ese.components.swing.panel.CrudControls.class, "getVisibleRect", null ); // NOI18N
            properties[PROPERTY_width] = new PropertyDescriptor ( "width", by.ese.components.swing.panel.CrudControls.class, "getWidth", null ); // NOI18N
            properties[PROPERTY_x] = new PropertyDescriptor ( "x", by.ese.components.swing.panel.CrudControls.class, "getX", null ); // NOI18N
            properties[PROPERTY_y] = new PropertyDescriptor ( "y", by.ese.components.swing.panel.CrudControls.class, "getY", null ); // NOI18N
        }
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_ancestorListener] = new EventSetDescriptor ( by.ese.components.swing.panel.CrudControls.class, "ancestorListener", javax.swing.event.AncestorListener.class, new String[] {"ancestorAdded", "ancestorRemoved", "ancestorMoved"}, "addAncestorListener", "removeAncestorListener" ); // NOI18N
            eventSets[EVENT_componentListener] = new EventSetDescriptor ( by.ese.components.swing.panel.CrudControls.class, "componentListener", java.awt.event.ComponentListener.class, new String[] {"componentResized", "componentMoved", "componentShown", "componentHidden"}, "addComponentListener", "removeComponentListener" ); // NOI18N
            eventSets[EVENT_containerListener] = new EventSetDescriptor ( by.ese.components.swing.panel.CrudControls.class, "containerListener", java.awt.event.ContainerListener.class, new String[] {"componentAdded", "componentRemoved"}, "addContainerListener", "removeContainerListener" ); // NOI18N
            eventSets[EVENT_focusListener] = new EventSetDescriptor ( by.ese.components.swing.panel.CrudControls.class, "focusListener", java.awt.event.FocusListener.class, new String[] {"focusGained", "focusLost"}, "addFocusListener", "removeFocusListener" ); // NOI18N
            eventSets[EVENT_hierarchyBoundsListener] = new EventSetDescriptor ( by.ese.components.swing.panel.CrudControls.class, "hierarchyBoundsListener", java.awt.event.HierarchyBoundsListener.class, new String[] {"ancestorMoved", "ancestorResized"}, "addHierarchyBoundsListener", "removeHierarchyBoundsListener" ); // NOI18N
            eventSets[EVENT_hierarchyListener] = new EventSetDescriptor ( by.ese.components.swing.panel.CrudControls.class, "hierarchyListener", java.awt.event.HierarchyListener.class, new String[] {"hierarchyChanged"}, "addHierarchyListener", "removeHierarchyListener" ); // NOI18N
            eventSets[EVENT_inputMethodListener] = new EventSetDescriptor ( by.ese.components.swing.panel.CrudControls.class, "inputMethodListener", java.awt.event.InputMethodListener.class, new String[] {"inputMethodTextChanged", "caretPositionChanged"}, "addInputMethodListener", "removeInputMethodListener" ); // NOI18N
            eventSets[EVENT_keyListener] = new EventSetDescriptor ( by.ese.components.swing.panel.CrudControls.class, "keyListener", java.awt.event.KeyListener.class, new String[] {"keyTyped", "keyPressed", "keyReleased"}, "addKeyListener", "removeKeyListener" ); // NOI18N
            eventSets[EVENT_mouseListener] = new EventSetDescriptor ( by.ese.components.swing.panel.CrudControls.class, "mouseListener", java.awt.event.MouseListener.class, new String[] {"mouseClicked", "mousePressed", "mouseReleased", "mouseEntered", "mouseExited"}, "addMouseListener", "removeMouseListener" ); // NOI18N
            eventSets[EVENT_mouseMotionListener] = new EventSetDescriptor ( by.ese.components.swing.panel.CrudControls.class, "mouseMotionListener", java.awt.event.MouseMotionListener.class, new String[] {"mouseDragged", "mouseMoved"}, "addMouseMotionListener", "removeMouseMotionListener" ); // NOI18N
            eventSets[EVENT_mouseWheelListener] = new EventSetDescriptor ( by.ese.components.swing.panel.CrudControls.class, "mouseWheelListener", java.awt.event.MouseWheelListener.class, new String[] {"mouseWheelMoved"}, "addMouseWheelListener", "removeMouseWheelListener" ); // NOI18N
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( by.ese.components.swing.panel.CrudControls.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
            eventSets[EVENT_vetoableChangeListener] = new EventSetDescriptor ( by.ese.components.swing.panel.CrudControls.class, "vetoableChangeListener", java.beans.VetoableChangeListener.class, new String[] {"vetoableChange"}, "addVetoableChangeListener", "removeVetoableChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
    ...
    private static String iconNameC16 = "/by/ese/components/etool_bar_16.png";//GEN-BEGIN:Icons
    private static String iconNameC32 = "/by/ese/components/etool_bar_32.png";
    private static String iconNameM16 = "/by/ese/components/etool_bar_16bw.png";
    private static String iconNameM32 = "/by/ese/components/etool_bar_32bw.png";//GEN-END:Icons
